...
const HOME_EN_TRANSLATIONS: Array<[string, string]> = [
  ...
  ["Entrepreneur · storyteller · community builder", "Entrepreneur · storyteller · community builder"],
  ["L'autore", "The author"],
  ["Andrea Magelli è un imprenditore, storyteller e costruttore di comunità.", "Andrea Magelli is an entrepreneur, storyteller, and builder of communities."],
  ["Per più di vent’anni ha lavorato all’incrocio tra innovazione, food, educazione, tecnologia e connessione umana, fondando e guidando progetti capaci di coinvolgere milioni di persone nel mondo.", "For more than twenty years, he has worked at the intersection of innovation, food, education, technology, and human connection, founding and leading projects that have engaged millions of people across the world."],
  ["Eppure questo libro non nasce dal successo professionale, dagli eventi globali o dai risultati raggiunti.", "Yet this book was not born from business success, global events, or professional achievements."],
  ["Nasce da una domanda più semplice.", "It was born from a simpler question."],
  ["Come padre, imprenditore e lifelong learner, Andrea esplora da anni la tensione tra identità e performance, successo e significato, tecnologia e umanità.", "As a father, entrepreneur, and lifelong learner, Andrea has spent years exploring the tension between identity and performance, achievement and meaning, technology and humanity."],
  ["Attraverso progetti che attraversano ospitalità, innovazione food, educazione globale e sviluppo rigenerativo, ha ritrovato ovunque la stessa sfida: siamo più connessi che mai, ma spesso lontani da noi stessi.", "Through ventures ranging from hospitality and food innovation to global education and regenerative development, he has witnessed the same challenge emerge everywhere: people are more connected than ever, yet often disconnected from themselves."],
  ["I AM Nobody non prova a dare risposte. È un invito a fermarsi, riflettere e ritrovare quella parte di noi che esiste oltre titoli, ruoli e aspettative.", "I AM Nobody is not an attempt to provide answers. It is an invitation to pause, reflect, and rediscover the part of ourselves that exists beyond titles, roles, and expectations."],
  ["Andrea vive tra idee, progetti e conversazioni che cercano di lasciare il mondo un po’ più consapevole, connesso e rigenerativo di come lo ha trovato.", "Andrea lives between ideas, projects, and conversations that seek to leave the world a little more conscious, connected, and regenerative than he found it."],
