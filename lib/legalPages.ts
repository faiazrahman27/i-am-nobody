...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box;margin:0;padding:0;}
    ...
    @media(hover:none){.nav-links a:active,.nav-toggle:active,.lang a:active{transform:translateY(-1px);color:#fff}.side a:active{color:#000;padding-left:8px}.footer-links a:active{color:#fff}}
